...
\begin{tabular}{p{2cm} p{12cm}}
	...
	PKI & \text{Public Key Infrastructure}\\
...
\subsubsection{Anonymity, Regulation, and Trust}
...
\subsection*{A.2: Euro 2.0 Contract Codebase} \label{ssec:a.2}
\url{https://github.com/cryptofiat/contract}

\subsection*{A.3: CryptoFiat Contract} \label{ssec:a.3}
\url{https://github.com/cryptofiat/contract/blob/master/CryptoFiat.sol}

\subsection*{A.4: Archive of Cited Web Pages} \label{ssec:a.4}
