...
Christopher David Raastad\\
\begin{LARGE}
\textsc{Euro 2.0 Digitaalne Valuuta Prototüübi Turvalisuse Analüüs\\}
\end{LARGE}
Magister\\[2cm]
\end{center}
...
\begin{itemize}
	\item Analysis of stakeholders behavior transition to Euro 2.0 system
...
\begin{itemize}
	...
	\item \textit{balance} - amount of Ether, the currency of Ethereum, in the account
...
\subsection{Solidity Smart Contracts} \label{sssec:2:ethereum:soliditySmartContracts}
