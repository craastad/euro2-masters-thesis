...
\todo[inline]{link back to asset profile definition in the last section}
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \\ \hline
  (2) Actor & Fraudster wanting to steal EUR2 for financial gain.
  \\ \hline
  (3) Means & 
    \begin{itemize}
...
\end{center}
\captionof{table}{Keys Stolen from User Device Risk Profile}
