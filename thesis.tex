...
\begin{quoting}
	\textbf{rq3.1:} \textit{What are the security, scalability, and privacy risks associated with the Euro 2.0 digital currency?}
\end{quoting}
\begin{quoting}
	\textbf{rq3.2:} \textit{What is the impact of the realised risks to stakeholders?}
\end{quoting}
\begin{quoting}
	\textbf{rq3.3:} \textit{What are the mitigation strategies or alternative design suggestions when implementing Euro 2.0?}
\end{quoting}
