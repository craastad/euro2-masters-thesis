...
\begin{LARGE}
\textsc{Security Analysis of the Euro 2.0 Digital Currency\\}
\end{LARGE}
Master thesis\\[2cm]
\end{center}
...
Christopher David Raastad\\
\begin{LARGE}
\textsc{Euro 2.0 Digitaalne Valuuta Turvalisuse Analüüs\\}
\end{LARGE}
Magister\\[2cm]
\end{center}
