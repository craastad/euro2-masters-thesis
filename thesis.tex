...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \textbf{Property} & \textbf{Description}
  \\ \hline
  (1) Threat Scenario & Attacker steals user private key from client application and steals sends all EUR2 to an account of his choice.
  \\ \hline
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  \\ \hline
  M & One Time Monetary Loss for a User			& 6	& High (3)		& 18
  \\ \hline
  R & Reputation and Monetary Confidence		& 5	& High (3)		& 15
  \\ \hline
  P & User Financial Information Revealed		& 4	& Low (1)		& 4
  \\ \hline
  S & Payments Network Unusable					& 3	& N/A (0)		& 0
  \\ \hline
  F & One Time Financial Loss for Foundation	& 2	& N/A (0)		& 0
  \\ \hline
  L & Fines and Lawsuits						& 1	& Medium (2)	& 2
  \\ \hline
  & & & \textbf{TOTAL} & 39
  \\ \hline
\end{tabular}
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \\ \hline
  (3) Means & Attacker find vulnerability in Accounts contract to set a increase a balance without restriction.
  \\ \hline
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  \\ \hline
  F & One Time Financial Loss for Foundation	& 2	& High (3)		& 6
  \\ \hline
  L & Fines and Lawsuits						& 1	& High (3)		& 3
  \\ \hline
  & & & \textbf{TOTAL} & 48
  \\ \hline
\end{tabular}
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \\ \hline
  (3) Means & Attacker queries ID server with ID codes acquired from outside source, gets challenge information, then breaks the challenge to get keys, and uses a dictionary attack to decrypt the keys.
  \\ \hline
  (4) Motive & Financial gain by gaining access to user funds.
  \\ \hline
  (5) Outcome &
 	 \begin{itemize}
  ...
  (8) Consequences &
    \begin{itemize}
		\item User loses his funds, leaves the system, and tells all his friends it cannot be trusted.
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  S & Payments Network Unusable					& 3	& N/A (0)		& 0
  \\ \hline
  F & One Time Financial Loss for Foundation	& 2	& Medium (2)	& 4
  \\ \hline
  L & Fines and Lawsuits						& 1	& Medium (2)	& 2
  \\ \hline
  & & & \textbf{TOTAL} & 43
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \\ \hline
  (3) Means & Ethereum does not solve scalability issues and cannot handle all the activity of all decentralized applications. Transactions are either significantly delayed or never picked up by miners.
  \\ \hline
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  \textbf{Impact Area} & \textbf{Description} & \textbf{Ranking} & \textbf{Value} & \textbf{Score}
  \\ \hline
  M & One Time Monetary Loss for a User			& 6	& N/A (0)		& 0
  \\ \hline
  R & Reputation and Monetary Confidence		& 5	& High (3)		& 15
  \\ \hline
  P & User Financial Information Revealed		& 4	& N/A (0)		& 0
...
\paragraph{(1) Steal Admin Keys from Online Server }
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \textbf{Property} & \textbf{Description}
  \\ \hline
  (1) Threat Scenario & An attacker tampers with the key generation process and compromises CryptoFiat master contract creation to deploy a new contract with backdoors into the entire system.
  \\ \hline
...
\paragraph{(3) Bribe Key Custodians }
...
\begin{tabular}{ | l | p{14cm} |}
  ...
  \\ \hline
  (3) Means & Bribe key custodians with an offer they can't refuse for access to the keys.
  \\ \hline
...
\end{center}
\captionof{table}{Risk Profile: Bribe Key Custodians}
...
\end{tabular}
\end{center}
\captionof{table}{(9) Severity: Bribe Key Custodians}
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  \textbf{Impact Area} & \textbf{Description} & \textbf{Ranking} & \textbf{Value} & \textbf{Score}
  \\ \hline
  M & One Time Monetary Loss for a User			& 6	& Low (1)		& 6
  \\ \hline
  R & Reputation and Monetary Confidence		& 5	& High (3)		& 15
  \\ \hline
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  S & Payments Network Unusable					& 3	& High (3)		& 9
  \\ \hline
  F & One Time Financial Loss for Foundation	& 2	& Low (1)		& 2
  \\ \hline
  L & Fines and Lawsuits						& 1	& High (3)		& 3
  \\ \hline
  & & & \textbf{TOTAL} & 39
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  \\ \hline
  (II:1) & Admin Keys & Steal Admin Keys from Online Server & Medium & 48
  \\ \hline
  (II:2) & Admin Keys & Tamper CryptoFiat Key Generation & Low & 51
  \\ \hline
  (II:3) & Admin Keys & Bribe Key Custodians & Low & 50
  \\ \hline
...
We arbitrarily divide total risk score into the three buckets 0 to 30 , 31 to 45, and 45 to 63. Based on risk analysis results we construct Relative Risk Matrix in \hypertableref{tab:relativeRiskMatrix}.
...
Key management is currently the toughest problem of cryptocurrency user experience. The reputation of the Euro 2.0 foundation hinges on the ability of users to securely manage their EUR2 keys. The current client wallet implementation stores keys in uses password protected local storage, which has the disadvantages of being easy to hack and easy to lose keys. Fortunately, the wallet solutions for Bitcoin keys are completely applicable to Ethereum. Eskandari et al. build a comprehensive comparison of key management techniques for Bitcoin juxtaposed to cash and online banking\cite{Eskandari2015}. We propose two mitigation approaches to helping users secure their keys, an air-gapped wallet like Armory or hosted wallet like Coinbase.

An air-gapped key storage wallet like Armory\cite{bitcoinArmory} allows users to a more malware resistant, offline, and recoverable key storage without a trusted third party, thus reducing the chance of theft or loss of keys. Since Bitcoin and Ethereum use the same key generation mechanism a similar solution could be built and offered by the Euro 2.0 foundation.

Another approach is for key storage to be completely delegated to a online third party, such as Bitcoin's Coinbase. This creates a user experience with the same properties as an online bank\cite{Eskandari2015} suitable for average users that don't want to deal with key management.
...
\begin{itemize}
	...
	\item Security audit of Euro 2.0 smart contracts by industry professionals, such as Smart Contract Solutions\cite{smartContractSolutions}
\end{itemize}
...
User keys stolen from the backup system is a risk that can be accepted for the time being. It only affects a single users who chooses to backup their keys. It has low likelihood due to the nature of the challenge. More research needs to be done on how cryptographically vulnerable is the challenge to attacks.

\paragraph{(I:5) Ethereum Scalability}

Mitigation Approach: \textbf{Accept}

Ethereum and blockchain scalability is an active avenue of development in the community with scalability initiatives such as Sharding\cite{shardingFaq} and Proof of Stake\cite{proofOfStakeFaq}. For the near future scalability is not an immediate threat to the viability of an Ethereum based digital currency like Euro 2.0.
...
\paragraph{(II:1) Steal Admin Keys from Online Server}
...
\todo[inline]{Chapter 5 conclusion and future work}
