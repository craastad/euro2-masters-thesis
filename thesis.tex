...
\subsubsection{(I) User Money Risk Profiles} \label{sssec:5.3:userMoneyRiskProfiles}
...
\subsubsection{(II) Ethereum Admin Keys Risk Profiles} \label{sssec:5.3:ethereumAdminKeysRiskProfiles}
...
\begin{tabular}{ | l | l | l | l | l |}
  ...
  S & Payments Network Unusable					& 3	& Medium (2)	& 6
  \\ \hline
  F & One Time Financial Loss for Foundation	& 2	& High (0)		& 6
  \\ \hline
  L & Fines and Lawsuits						& 1	& High (2)		& 2
  \\ \hline
  & & & \textbf{TOTAL} & 26
  \\ \hline
\end{tabular}
...
\subsubsection{(III) User Identity Risk Profiles} \label{sssec:5.3:userIdentityRiskProfiles}
