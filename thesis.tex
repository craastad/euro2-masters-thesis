...
The \textit{Constants} contract holds values for contract ids (used in contract deployment mapping), bucket identifiers (used in data storage keys), account states (used in accounts and transactions), and events.
