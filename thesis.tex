...
\begin{itemize}
	...
	\item \textbf{Y} is client, admin, or server. Client is a user of the system, admin is some superuser with special permissions, and server is some centralised or decentralised server infrastructure
...
\begin{itemize}
	\item \textbf{CS7} - Fulfil delegated EUR2 transaction and claim EUR2 fee
\end{itemize}
