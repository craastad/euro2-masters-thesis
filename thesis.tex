...
\begin{itemize}
	...
	\item \todo[inline]{some operation to verify that this transaction can actually happen}
\end{itemize}
...
After explaining the features and implementation details of the Euro 2.0 system in \hyperref[sec:3]{Chapter 3} and exploring the change in relationship with money of stakeholders \hyperref[sec:4]{Chapter 4}, we are ready to analyze the risks of Euro 2.0 system. This chapter answers the research question:
...
Questions \textbf{RQ3.1} through \textbf{RQ3.5} are answered by applying the OCTAVE Allegro risk assessment methodology\cite{CaralliIntroducingOCTAVE2007}.

\todo[inline]{explain what happens in the following sections} 
